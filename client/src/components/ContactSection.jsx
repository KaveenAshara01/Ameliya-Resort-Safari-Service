    ...
    <section id="contact" className="py-20 px-4 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-gray-300 mb-12">
          Ready to plan your next adventure? Contact us through WhatsApp or Email
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-8">
            <a
              ...
              className="bg-green-500 hover:bg-green-600 p-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-xl group"
            >
            <div className="flex flex-col items-center">
              ...
              <p className="mt-2 font-semibold">{whatsappNumber}</p>
            </div>
          </a>

          <a
            href={`mailto:${email}?subject=Tourism Package Inquiry`}
            className="bg-primary-600 hover:bg-primary-700 p-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-xl group"
          >
            <div className="flex flex-col items-center">
              ...
              <p className="text-primary-100">Send us an email</p>
